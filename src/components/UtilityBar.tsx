...
export default function UtilityBar({codeElemRef}: {codeElemRef: RefObject<HTMLDivElement | null>}) {
  ...
  return (
    <div className="min-w-[50%] flex items-center justify-between bg-gray-200 dark:bg-[#1d1d1d] h-12 absolute bottom-0 border-b border-t border-l border-r border-gray-400 rounded-t-md p-2 dark:border-[#2e2f2ff0] m-auto px-1 ">
        <button
        onClick={randomize}
        className="flex mx-2 justify-center items-center dark:hover:bg-[#4b4a4a] bg-[#d1d5dc] dark:bg-[#333334] dark:text-white py-1 px-3 text-sm font-semibold rounded-md cursor-pointer hover:bg-[#9a9da2]"
        >
        ...
        <button
        onClick={() => handleCopy()}
        className="flex mx-2 justify-center items-center hover:bg-[#9a9da2] dark:hover:bg-[#4b4a4a] bg-[#d1d5dc] dark:bg-[#333334] dark:text-white py-1 px-3 text-sm font-semibold rounded-md cursor-pointer"
        >
        ...
        flex  mx-2 justify-center items-center dark:bg-[#102a4c] dark:hover:bg-[#304157] dark:text-[#50a8ff] py-1 px-3 text-sm rounded-md cursor-pointer font-bold hover:bg-[#65b0fb]"
        >
        <span className="mr-2">
