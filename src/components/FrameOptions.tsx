    ...
    return (
        <div className="w-full lg:pl-2 pr-0.5 lg:pr-1 flex flex-col">
            ...
            <div className="ml-3  flex flex-col mt-2 ">
                ...
                <div className="lg:pl-0.5 xl:pl-1 mb-2 flex justify-between items-center">
                    <span className="text-[13px] font-semibold text-black dark:text-white">Background</span>
                    <div className="flex items-center justify-between py-1 px-2 rounded-md bg-gray-300 text-sm md:w-30 lg:w-32  xl:w-38 dark:bg-[#232323] ">
                        <input type="color" 
